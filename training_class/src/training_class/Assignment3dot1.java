...
public class Assignment3dot1 {
	...
	public static void main( String [] args ) {
		...
		queries[1] = " SELECT * FROM ( "
				+ "SELECT tbl_book_copies.noOfCopiesopies FROM tbl_book_copies INNER JOIN tbl_library_branch"
				+ " ON tbl_library_branch.branchId = tbl_book_copies.branchId"
				+ "UNION"
				+ "SELECT tbl_book_copies.noOfCopiesopies FROM tbl_book_copies INNER JOIN tbl_book.bookId = tbl_book_copies.bookId "
